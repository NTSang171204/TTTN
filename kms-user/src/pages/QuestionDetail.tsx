                ...
                <CardContent className="p-8">
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => toggleFavorite(String(question.id))}
                      className={`${
                        isFavorited(String(question.id))
                    ...
                    >
                      <Heart
                        className={`h-5 w-5 ${
                          isFavorited(String(question.id)) ? "fill-current" : ""
                        }`}
                      />
                    </Button>
                  </div>
                        ...
                        >
                          <ThumbsUp
                            className={`h-4 w-4 mr-1 ${
                              isLiked(String(question.id)) ? "fill-current" : ""
                            }`}
                          />
                          {question.likes_count +
                            (isLiked(String(question.id)) ? 1 : 0)}
                        </Button>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Button
                        ...
                        >
                          ...
                          {question.dislikes_count +
                            (isDisliked(String(question.id)) ? 1 : 0)}
                        </Button>
                      </div>
